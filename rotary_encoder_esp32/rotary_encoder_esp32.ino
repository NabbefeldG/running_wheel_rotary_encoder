...
void loop() {
  ...
  //                                            ";" + String(wheel_counter2.cw_counter) + ";" + String(wheel_counter2.ccw_counter));
      // Send to PC - I add the "Time in ms:" cause I observed the first few chars to have gotten lost in transmission. This is basically just data padding.
      Serial.println("Time in ms:" + msg);
